<script>
    ...
    function exportar_tabla() {
        ...
        if (datos['desde_mensual'] <= datos['hasta_mensual'] && datos['desde_semanal'] <= datos['hasta_semanal']) {
            ...
            $.LoadingOverlay('show');
            window.open('{{ url('tbl_ventas/exportar_tabla') }}' + '?datos=' + datos, '_blank');
            $.LoadingOverlay('hide');
        }
    }
    ...
    function exportar_variedades() {
        ...
        if (datos['desde_mensual'] <= datos['hasta_mensual'] && datos['desde_semanal'] <= datos['hasta_semanal']) {
            datos = JSON.stringify(datos);
            $.LoadingOverlay('show');
            window.open('{{ url('tbl_ventas/exportar_variedades') }}' + '?datos=' + datos, '_blank');
            $.LoadingOverlay('hide');
        }
    }
</script>
