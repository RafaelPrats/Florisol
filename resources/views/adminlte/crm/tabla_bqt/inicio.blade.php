...
@section('contenido')
    ...
    <section class="content-header">
        <h1>
            Tabla
            <small class="text-color_yura">Bqt</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <td colspan="4">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control input-yura_default text-center filtro_rango"
                            ...
                            value="{{ substr($semana_pasada->codigo, 2, 2) }}" maxlength="2"
            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <select name="variedad" id="variedad" class="input-yura_default form-control"
                            style="width: 100%">
                            <option value="T">Todas las Bqts</option>
                            @foreach ($recetas as $item)
                                <option value="{{ $item->id_variedad }}">{{ $item->siglas . ': ' . $item->nombre }}</option>
                            @endforeach
                        </select>
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        ...
                        <select name="filtro_criterio" id="filtro_criterio" class="input-yura_default form-control"
                            style="width: 100%">
                            <option value="R">Recetas</option>
                            <option value="P">Ventas</option>
                        </select>
...
@section('script_final')
    @include('adminlte.crm.tabla_bqt.script')
@endsection
