            ...
            <tr>
                ...
                <td>
                    <div class="input-group div_group_filtro">
                        ...
                        <input type="date" id="desde_filtro" class="form-control text-center"
                ...
                <td>
                    <div class="input-group div_group_filtro">
                        ...
                        <input type="date" id="hasta_filtro" class="form-control text-center"
                            value="{{ hoy() }}">
                        <div class="input-group-btn">
                            <button class="btn btn-yura_primary" onclick="listar_reporte()">
                                <i class="fa fa-fw fa-search"></i>
                            </button>
                            <button class="btn btn-yura_default" onclick="add_guardes()">
...
@section('script_final')
    ...
    @include('adminlte.gestion.guarde.guarde_flor.script')
@endsection
