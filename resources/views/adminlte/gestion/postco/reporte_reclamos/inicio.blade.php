                    ...
                    <div class="input-group">
                        ...
                        <select name="filtro_motivo" id="filtro_motivo" class="form-control">
                            ...
                            @foreach ($motivos as $m)
                                <option value="{{ $m->id_motivo_reclamo }}">{{ $m->nombre }}</option>
                            @endforeach
                        </select>
                    </div>
                </td>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <select name="filtro_tipo" id="filtro_tipo" class="form-control">
                            ...
                            <option value="V">Recetas</option>
                            <option value="M">Motivos</option>
                            <option value="L">Linea de Produccion</option>
                        </select>
...
@section('script_final')
    ...
    @include('adminlte.gestion.postco.reporte_reclamos.script')
@endsection
