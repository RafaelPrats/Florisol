            ...
            <tr>
                ...
                <td>
                    <div class="input-group">
                        ...
                        <input type="date" id="desde_filtro" class="form-control" onchange="listar_reporte()"
                ...
                <td>
                    <div class="input-group">
                        ...
                        <input type="date" id="hasta_filtro" class="form-control" onchange="listar_reporte()"
                            value="{{ hoy() }}">
...
@section('script_final')
    ...
    @include('adminlte.gestion.postco.re_armado.script')
@endsection
