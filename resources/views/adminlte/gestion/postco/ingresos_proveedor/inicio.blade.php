                ...
                <td>
                    <div class="input-group">
                        ...
                        <input type="date" name="desde_filtro" id="desde_filtro" class="form-control"
                            value="{{ opDiasFecha('-', 28, hoy()) }}" max="{{ hoy() }}">
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            ...
                            <button type="button" class="btn btn-yura_dark hidden" title="Exportar Reporte"
...
@section('script_final')
    @include('adminlte.gestion.postco.ingresos_proveedor.script')
@endsection
