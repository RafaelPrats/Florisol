            ...
            <tr>
                <td>
                    <div class="input-group" style="margin-top: 5px;">
                        ...
                        <input type="date" id="desde_filtro" class="form-control input-yura_default text-center"
                            value="{{ hoy() }}">
                    </div>
                </td>
                <td>
                    <div class="input-group" style="margin-top: 5px;">
                        ...
                        <input type="date" id="hasta_filtro" class="form-control input-yura_default text-center"
                ...
                <td>
                    <div class="input-group" style="margin-top: 5px;">
                        ...
                        <select id="flor_filtro" class="form-control input-yura_default" onchange="listar_reporte()"
                            style="width: 100%">
...
@section('script_final')
    @include('adminlte.gestion.postcocecha.planificacion.script')
@endsection
