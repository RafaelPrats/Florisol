            ...
            <tr>
                ...
                <td>
                    <div class="input-group" style="margin-top: 5px;">
                        ...
                        <select id="usuario_filtro" class="form-control">
                ...
                <td>
                    <div class="input-group" style="margin-top: 5px;">
                        ...
                        <div class="input-group-btn">
                            ...
                            <button class="btn btn-yura_dark" onclick="add_despacho()">
...
@section('script_final')
    @include('adminlte.gestion.postcocecha.despacho_proveedor.script')
@endsection
