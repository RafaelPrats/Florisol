                ...
                <td>
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            ...
                            <button class="btn btn-primary btn-yura_default" onclick="ver_procesos()" style="color: black"
                                title="Ver procesos en segundo plano">
...
@section('script_final')
    @include('adminlte.gestion.postcocecha.disponibilidad_flor.script')
@endsection
