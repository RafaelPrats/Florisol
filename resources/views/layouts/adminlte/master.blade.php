...
<body class="hold-transition skin-black sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2018-{{ date('Y') }} Benchflow</strong> All rights
            reserved.
        </footer>
    ...
    <script>
        ...
        function cargar_chatbot() {
            if ($('#chat_cargado').val() == 0) {
                datos = {};
                get_jquery('{{ url('chatbot/cargar_chatbot') }}', datos, function(retorno) {
                    $('#div_chatbot').html(retorno);
                    $('#chat_cargado').val(1);
                });
            }
        }
        ...
        function modal_view(id_modal, mensaje, title, draggable, closable, size, funcion) {
            BootstrapDialog.show({
                title: title,
                closable: closable,
                draggable: draggable,
        ...
        $.LoadingOverlaySetup({
            ...
            image: "{{ url('images/Logo_Bench_Flow_B.png') }}",
        ...
        function notificar(body, url, accion, timeout, beep = true) {
            Push.create('Hola', {
                body: body,
                icon: '{{ url('images/Logo_Bench_Flow_B.png') }}',
                link: '/#',
